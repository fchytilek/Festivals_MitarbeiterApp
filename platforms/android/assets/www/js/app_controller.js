app.controller('testController', function($scope, $state,  $window, $ionicScrollDelegate, $ionicHistory, $ionicViewSwitcher, $ionicPopup, $ionicPopover) {
    ...
    $scope.ma_details = function(username) {
        ...
        $.ajax({
            type: "GET",
            url: "http://tomcat01lab.cs.univie.ac.at:31740/MitarbeiterApp/veranstaltung/ma_details",
            data: json,
            dataType: 'json'
        }).then(function(data){
    ...
    $scope.offene_arbeiten_anzeigen = function() {
        ...
        $.ajax({
                type: "GET",
                url: "http://tomcat01lab.cs.univie.ac.at:31740/MitarbeiterApp/veranstaltung/offeneArbeiten",
                data: json,
                dataType: 'json'
            }).then(function(data) {
